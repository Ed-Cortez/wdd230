...
const url = "https://api.openweathermap.org/data/2.5/weather?lat=-12.046331484873207&lon=-77.04277564288267&units=metric&appid=dc623eb500ac341d4a193ec56d78ed2d";
...
function windchill(){
    ...
    windchill.innerHTML += `<p>Wind Chill: ${result}&deg;C</p>`;    
}